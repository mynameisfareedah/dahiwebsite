        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-8 px-4 sm:px-6 lg:flex-row lg:justify-between lg:px-8">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-3">
              <a href="mailto:docadi.healthintiative@gmail.com" className="text-slate-300 transition hover:text-white">Email</a>
              <a href="https://whatsapp.com/channel/0029VbBdF4hLI8YZRabyWF0j" target="_blank" rel="noopener" className="text-slate-300 transition hover:text-white">WhatsApp</a>
              <a href="https://www.facebook.com/share/1A8VVfnJyr" target="_blank" rel="noopener" className="text-slate-300 transition hover:text-white">Facebook</a>
              <a href="https://www.instagram.com/docadihealthintiative_?igsh=YmtnbW1hZnp6MWFz" target="_blank" rel="noopener" className="text-slate-300 transition hover:text-white">Instagram</a>
              <a href="https://youtube.com/@dahi-01?si=b54Rt5TiEc5Yvb7q" target="_blank" rel="noopener" className="text-slate-300 transition hover:text-white">YouTube</a>
              <Link to="/contact" className="text-slate-300 transition hover:text-white">Contact</Link>
            </div>
            <p className="text-sm text-slate-500">© 2026 Doc Adi Health Initiative. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
